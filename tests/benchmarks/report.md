...
*generated: 2026-07-25T14:07:18Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (418 ms, 180 posts) |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1784988263.3887684
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260725T140423-compose_audit-305e82.md",
      "artefacts/20260725T140423-render_report-a9ab35.md",
      "artefacts/20260725T140423-summarise_findings-073552.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-44foq3y7/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.07462334632873535,
