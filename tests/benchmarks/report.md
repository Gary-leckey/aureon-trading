...
*generated: 2026-08-07T22:06:28Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (481 ms, 180 posts) |
...
| 51 | Capability grid (all Aureon domains through the hive) | **PASS** | 5/5 capability lanes on real organs: 464 swarm steps (2320 agent updates) in 0.227549s (~0.49 ms/step); gate selective in every lane; dark-source refusal proven; marches deterministic |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1786140003.844775
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260807T220003-compose_audit-b544b5.md",
      "artefacts/20260807T220003-render_report-f28dda.md",
      "artefacts/20260807T220003-summarise_findings-a1935b.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-b5a2hwp1/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.0729520320892334,
...
```json
{
  ...
  "metrics": {
    "lanes_ran": 5,
    "total_steps": 464,
    "total_elapsed_s": 0.227549,
    "avg_ms_per_step": 0.49,
    "total_agent_updates": 2320,
    "per_lane_steps_per_s": {
      "accounting": 1870.1,
      "coding": 2034.8,
      "fintech": 2155.9,
      "pattern_recognition": 2012.3,
      "trading": 2114.1
    },
    "per_lane_actualized": {
      "accounting": "20/98",
