...
*generated: 2026-08-07T16:13:31Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (628 ms, 180 posts) |
...
| 51 | Capability grid (all Aureon domains through the hive) | **PASS** | 5/5 capability lanes on real organs: 463 swarm steps (2315 agent updates) in 0.300459s (~0.65 ms/step); gate selective in every lane; dark-source refusal proven; marches deterministic |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1786118739.7700784
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260807T160539-compose_audit-16c630.md",
      "artefacts/20260807T160539-render_report-4bdad4.md",
      "artefacts/20260807T160539-summarise_findings-4253b4.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-i1_gox92/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.07287383079528809,
...
```json
{
  ...
  "metrics": {
    "lanes_ran": 5,
    "total_steps": 463,
    "total_elapsed_s": 0.300459,
    "avg_ms_per_step": 0.649,
    "total_agent_updates": 2315,
    "per_lane_steps_per_s": {
      "accounting": 1427.9,
      "coding": 1499.9,
      "fintech": 1493.1,
      "pattern_recognition": 1594.4,
      "trading": 1562.8
    },
    "per_lane_actualized": {
      "accounting": "20/98",
