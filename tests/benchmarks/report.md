...
*generated: 2026-08-07T15:26:57Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (650 ms, 180 posts) |
...
| 51 | Capability grid (all Aureon domains through the hive) | **PASS** | 5/5 capability lanes on real organs: 463 swarm steps (2315 agent updates) in 0.401588s (~0.87 ms/step); gate selective in every lane; dark-source refusal proven; marches deterministic |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1786115928.0118282
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260807T151848-compose_audit-c0c5e4.md",
      "artefacts/20260807T151848-render_report-781f4a.md",
      "artefacts/20260807T151848-summarise_findings-101c9f.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-1a5kiyiz/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.07382750511169434,
...
```json
{
  ...
  "metrics": {
    "lanes_ran": 5,
    "total_steps": 463,
    "total_elapsed_s": 0.401588,
    "avg_ms_per_step": 0.867,
    "total_agent_updates": 2315,
    "per_lane_steps_per_s": {
      "accounting": 1649.2,
      "coding": 1515.3,
      "fintech": 1504.3,
      "pattern_recognition": 742.6,
      "trading": 1586.5
    },
    "per_lane_actualized": {
      "accounting": "20/98",
