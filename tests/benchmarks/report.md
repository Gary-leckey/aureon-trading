...
*generated: 2026-07-25T15:27:14Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (445 ms, 180 posts) |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1784993049.4264722
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260725T152409-compose_audit-157977.md",
      "artefacts/20260725T152409-render_report-5fd6c5.md",
      "artefacts/20260725T152409-summarise_findings-46ac57.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-8_376zit/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.07443404197692871,
