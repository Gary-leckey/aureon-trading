...
*generated: 2026-07-25T11:42:05Z*
...
| 4 | Mesh convergence (PhiBridgeMesh, in-process LAN) | **PASS** | 20 vaults converged to identical 400-hash set in 3 cycles (508 ms, 180 posts) |
...
```json
{
  ...
  "metrics": {
    "track_record_for_build": {
      ...
      "last_seen_ts": 1784979528.4789143
    },
    "persona_health": {
      "persona": "engineer",
      "action_count": 0,
...
```json
{
  ...
  "metrics": {
    ...
    "artefacts_on_disk": [
      "artefacts/20260725T113848-compose_audit-d04fe2.md",
      "artefacts/20260725T113848-render_report-4f06bc.md",
      "artefacts/20260725T113848-summarise_findings-cfa1f9.md"
    ],
    ...
    "stats": {
      ...
      "abandoned": 0,
      "subscribed": true,
      "output_root": "/tmp/aureon-bench-c7wlw3nl/a7/artefacts"
    }
  },
  "invariants": {
    "no_abandonment": true,
...
```json
{
  ...
  "metrics": {
    ...
    "lambda_delta_t": 0.0771327018737793,
